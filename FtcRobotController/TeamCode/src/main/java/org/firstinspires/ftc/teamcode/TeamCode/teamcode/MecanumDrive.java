...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0029296757644368745;//inch devided by ticks
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            DriveFrontLeft.setPower(leftFrontPower);
            DriveBackLeft.setPower(leftBackPower);
            DriveBackRight.setPower(rightBackPower);
            DriveFrontRight.setPower(rightFrontPower);
    ...
    public final class TurnAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            DriveFrontLeft.setPower(feedforward.compute(wheelVels.leftFront) / voltage);
            DriveBackLeft.setPower(feedforward.compute(wheelVels.leftBack) / voltage);
            DriveBackRight.setPower(feedforward.compute(wheelVels.rightBack) / voltage);
            DriveFrontRight.setPower(feedforward.compute(wheelVels.rightFront) / voltage);
