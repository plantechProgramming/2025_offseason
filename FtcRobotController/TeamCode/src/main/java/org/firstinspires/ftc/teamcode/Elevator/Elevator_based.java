...
public class Elevator_based extends SubsystemBase {
    ...
    public Elevator_based(DcMotorEx EL, DcMotorEx ER, Servo intake_center, CRServo intake_left, CRServo intake_right, Servo intake_AR, Servo intAR, Telemetry telemetry){
        this.El = EL;
        this.ER = ER;
