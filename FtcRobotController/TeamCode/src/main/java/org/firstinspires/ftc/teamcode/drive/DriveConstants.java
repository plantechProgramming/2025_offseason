...
public class DriveConstants {
     ...
     */
    public static final double TICKS_PER_REV = 234.18;
    ...
    // for 96 diam wheels, might change
    public static double WHEEL_RADIUS = 48; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 36.5; // in
