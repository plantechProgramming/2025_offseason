...
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.GoBildaPinpointDriver;
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.MecanumDrive;
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.OTOSLocalizer;
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.PinpointLocalizer;
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.TankDrive;
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.ThreeDeadWheelLocalizer;
import org.firstinspires.ftc.teamcode.TeamCode.teamcode.TwoDeadWheelLocalizer;
            ...
            dvf = hardwareMap -> {
                ...
                if (md.localizer instanceof MecanumDrive.DriveLocalizer) {
                    ...
                    encoderGroups.add(new LynxQuadratureEncoderGroup(
                            ...
                            Arrays.asList(dl.FL, dl.BL, dl.FR, dl.BR)
                    ));
                    ...
                    encoderGroups.add(new LynxQuadratureEncoderGroup(
                            hardwareMap.getAll(LynxModule.class),
                            Arrays.asList(dl.DriveBackLeft, dl.DriveFrontRight)
                    ));
                    parEncs.add(new EncoderRef(0, 0));
